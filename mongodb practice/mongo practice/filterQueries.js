...
const mongoose= require("mongoose");
 ...
 function topSalesToday() {
  ...
  Transaction.find({
    ...
    .limit(10)
    .then(result=> console.log('Top sales for December 1st:', result))
    .catch(err=>console.error('Error retrieving top sales:', err))
...
const topSalesThisMonth = () => {
  ...
  .then(result=>console.log('Top sales this month:', result))
  .catch(err=>console.error('Error retrieving top sales this month:', err))
  ...
  const topSalesThisMonthOver50000 =  () => {
  ...
  const mostSoldProducts =  () => {
    ...
    .then(result=>console.log('Most sold products this month:', result))
    .catch(err=>console.error('Error retrieving most sold products this month:', err))
  };
  
  
  //most sold products over 500 this month

  const mostSoldProductsOver500 = () => {
    ...
    .then(results=>console.log('Most sold products this month:', results))
    .catch(err=>console.error('Error retrieving most sold products this month:', err))
...
const electronics= ()=>{
  ...
  .catch(err=>console.error('Error retrieving revenue by electronics products this month:', err))
